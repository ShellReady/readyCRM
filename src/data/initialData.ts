...
export const INITIAL_LEADS: Lead[] = [
  ...
  {
    id: 'lead-10',
    name: 'Rodrigo Santander',
    companyContact: 'Distribuidora Nacional de Carga',
    position: 'VP de Supply Chain & IT',
    email: 'rsantander@carganacional.cl',
    phone: '+56 2 2911 4400',
    linkedin: 'https://linkedin.com/in/rodrigo-santander-supply',
    companyId: 'comp-1',
    timezone: 'America/Santiago',
    stage: 'En Conversación',
    bant: {
      ...
      need: true,
      timeline: false,
      notes: 'Evaluando sustitución de su sistema WMS hacia la nube. Presupuesto estimado en $22k.',
    },
    icpScore: 89,
    icpJustification: 'Gran encaje con SaaS Scale Latam: Empresa de distribución mayorista con más de 60 vehículos y necesidad crítica de trazabilidad de pedidos en tiempo real.',
    icpLastEvaluated: '2026-08-27T11:00:00.000Z',
    icpScoreStatus: 'Confirmado por usuario',
    temperature: 'Tibio',
    semaforo: 'Amarillo',
    semaforoDescription: 'Interesado en la demo técnica pero solicitó cuadro comparativo de integración con ERP SAP R/3.',
    nextAction: 'Enviar cuadro comparativo de conectores API y agendar llamada de 15 minutos.',
    estimatedValue: 22000,
    summary: 'Rodrigo busca automatizar la recepción de guías y optimizar la planificación de rutas. Su equipo de IT está validando la seguridad en nube.',
    summaryUpdatedAt: '2026-08-27',
    followUpDate: '2026-08-30',
  ...
  },
  {
    ...
    companyContact: 'Transportes del Pacífico S.A.',
    position: 'Directora de Transformación Digital',
    email: 'gfuentes@transpacifico.pe',
    phone: '+51 1 680 9234',
    linkedin: 'https://linkedin.com/in/gabriela-fuentes-tech',
    companyId: 'comp-1',
    ...
    bant: {
      ...
      need: true,
      timeline: true,
      notes: 'Aprobación del directorio programada para esta semana. Presupuesto $30k aprobado.',
    },
    icpScore: 95,
    icpJustification: 'Lead estratégico ideal para SaaS Scale: Directora con patrocinio del CEO en empresa de transporte líder en Perú. Propuesta comercial enviada y en fase final de revisión legal.',
    icpLastEvaluated: '2026-08-28T16:00:00.000Z',
    icpScoreStatus: 'Confirmado por usuario',
    temperature: 'Caliente',
    semaforo: 'Verde',
    semaforoDescription: 'Propuesta enviada y revisada con feedback positivo. Esperando firma de contrato.',
    nextAction: 'Llamada de seguimiento con Closer para firma de acuerdo de confidencialidad y contrato final.',
    estimatedValue: 30000,
    summary: 'Reunión exploratoria y demostración técnica completadas. Gabriela confirmó que la solución cumple con los requerimientos operativos del directorio.',
    summaryUpdatedAt: '2026-08-28',
  ...
  {
    id: 'lead-12',
    name: 'Camilo Echeverría',
    companyContact: 'UrbanStyle Footwear D2C',
    position: 'CEO & Founder',
    email: 'camilo@urbanstyle.co',
    phone: '+57 300 456 7812',
    linkedin: 'https://linkedin.com/in/camilo-echeverria-urban',
    companyId: 'comp-2',
    timezone: 'America/Bogota',
    stage: 'Calificado BANT',
    bant: {
      ...
      need: true,
      timeline: true,
      notes: 'Ventas de $45k/mes en Shopify. Inversión en pauta de $12k/mes buscando reducir CPA.',
    },
    icpScore: 91,
    icpJustification: 'Alineación perfecta con Growth Agency X: Founder de marca D2C de calzado urbano con tracción probada y presupuesto publicitario listo para escalar.',
    icpLastEvaluated: '2026-08-27T14:00:00.000Z',
    icpScoreStatus: 'Confirmado por usuario',
    temperature: 'Caliente',
    semaforo: 'Verde',
    semaforoDescription: 'Alta afinidad. Pidió auditoría de su cuenta de Meta Ads y benchmark de la industria.',
    nextAction: 'Enviar reporte de auditoría preliminar y enlace de Calendly para videollamada.',
    estimatedValue: 5000,
    summary: 'Camilo fundó UrbanStyle hace 3 años y factura $45k/mes. Quiere escalar a México y Estados Unidos con creatividades UGC y estrategia TikTok Ads.',
    summaryUpdatedAt: '2026-08-27',
    followUpDate: '2026-08-29',
  ...
  },
  {
    id: 'lead-13',
    name: 'Sofía Navarro',
    companyContact: 'GlowSkin Cosmética Natural',
    position: 'Directora de Marketing Digital',
    email: 'snavarro@glowskin.mx',
    phone: '+52 55 8890 1234',
    linkedin: 'https://linkedin.com/in/sofia-navarro-glow',
    companyId: 'comp-2',
    timezone: 'America/Mexico_City',
    stage: 'Propuesta Enviada',
    bant: {
      ...
      need: true,
      timeline: true,
      notes: 'Retainer mensual propuesto de $2,100 USD/mes con 3 meses de compromiso.',
    },
    icpScore: 89,
    icpJustification: 'Marca consolidada de belleza y cuidado facial con catálogo propio y ecommerce en expansión. Directora con facultad de contratación directa.',
    icpLastEvaluated: '2026-08-28T10:00:00.000Z',
    icpScoreStatus: 'Confirmado por usuario',
    temperature: 'Caliente',
    semaforo: 'Verde',
    semaforoDescription: 'Propuesta de Retainer Performance en revisión por gerencia.',
    nextAction: 'Seguimiento por WhatsApp para resolver dudas sobre el entregable de creatividades mensuales.',
    estimatedValue: 4200,
    summary: 'Sofía revisó la auditoría de cuenta publicitaria y aprobó el enfoque de atribución multicanal. En espera de visto bueno para arranque de campaña.',
    summaryUpdatedAt: '2026-08-28',
    followUpDate: '2026-08-30',
  ...
  },
  {
    ...
    companyContact: 'Global Payroll Solutions Latam',
    position: 'Head of Treasury & Payments',
    email: 'lvalenzuela@globalpayroll.lat',
    phone: '+52 55 3344 5566',
    linkedin: 'https://linkedin.com/in/lucia-valenzuela-treasury',
    companyId: 'comp-3',
    timezone: 'America/Mexico_City',
    stage: 'Calificado BANT',
    bant: {
      ...
      need: true,
      timeline: true,
      notes: 'Dispersión de nómina a más de 1,200 colaboradores en 6 países. Necesidad crítica de pagos SPEI y ACH.',
    },
    icpScore: 97,
    icpJustification: 'Cuenta Enterprise de máxima prioridad: Plataforma de nómina global con volumen transaccional de $1.2M USD mensuales. Validación técnica en curso con el equipo de tesorería.',
    icpLastEvaluated: '2026-08-28T15:30:00.000Z',
    icpScoreStatus: 'Confirmado por usuario',
    temperature: 'Caliente',
    semaforo: 'Verde',
    semaforoDescription: 'Reunión de calificación completada con excelente recepción del equipo de tesorería.',
    nextAction: 'Coordinar sesión técnica de pruebas en Sandbox con el equipo de desarrollo de Fintech B2B.',
    estimatedValue: 60000,
    summary: 'Lucía confirmó que procesan más de $1.2M mensuales en dispersiones salariales internacionales y necesitan reducir comisiones bancarias del 3.5% al 0.8% vía API.',
    summaryUpdatedAt: '2026-08-28',
    followUpDate: '2026-08-30',
  ...
  },
  {
    id: 'lead-15',
    name: 'Matías Rivas',
    companyContact: 'NeoCambio Fintech & Remesas',
    position: 'Director de Tecnología e Infraestructura',
    email: 'mrivas@neocambio.com',
    phone: '+54 11 4455 6677',
    linkedin: 'https://linkedin.com/in/matias-rivas-tech',
    companyId: 'comp-3',
    timezone: 'America/Buenos_Aires',
    stage: 'Cerrado Ganado',
    bant: {
      ...
      need: true,
      timeline: true,
      notes: 'Contrato anual cerrado por valor de $45,000 USD.',
    },
    icpScore: 93,
    icpJustification: 'Empresa fintech de remesas y cambio de divisas con operación multi-país. Firma de contrato anual completada tras pruebas exitosas de latencia en API.',
    icpLastEvaluated: '2026-08-26T18:00:00.000Z',
    icpScoreStatus: 'Confirmado por usuario',
    temperature: 'Caliente',
    semaforo: 'Verde',
    semaforoDescription: 'Cliente cerrado. Fase de integración a producción iniciada.',
    nextAction: 'Monitorear primer lote de dispersión en producción y emitir registro de comisión.',
    estimatedValue: 45000,
    summary: 'Contrato corporativo firmado para integración de API transfronteriza con SLA 99.99% y soporte dedicado.',
    summaryUpdatedAt: '2026-08-26',
...
export const INITIAL_INTERACTIONS: Interaction[] = [
  ...
  },
  {
    ...
    channel: 'Email',
    type: 'Objeción',
    note: 'Rodrigo solicitó documentación de soporte para migración desde SAP R/3 hacia el ERP cloud.',
  },
  {
    id: 'int-12',
    leadId: 'lead-11',
    ...
    channel: 'Llamada',
    type: 'Seguimiento',
    note: 'Gabriela confirmó recepción de la propuesta de $30k y agendó revisión con el directorio.',
  },
  {
    id: 'int-13',
    leadId: 'lead-12',
    ...
    channel: 'WhatsApp',
    type: 'Respuesta positiva',
    note: 'Camilo solicitó la auditoría de cuenta de Meta Ads y compartió accesos de lectura.',
  },
  {
    id: 'int-14',
    leadId: 'lead-13',
    ...
    channel: 'Email',
    type: 'Seguimiento',
    note: 'Envío de propuesta económica de Growth Retainer Performance a Sofía Navarro.',
  },
  {
    id: 'int-15',
    leadId: 'lead-14',
    ...
    channel: 'Llamada',
    type: 'Respuesta positiva',
    note: 'Lucía confirmó interés prioritario en API SPEI masivo para dispersión de nómina.',
  },
  {
    id: 'int-16',
    leadId: 'lead-15',
    ...
    channel: 'Llamada',
    type: 'Cierre',
    note: 'Firma de contrato anual completada con Matías Rivas (NeoCambio Fintech).',
  },
];
...
export const INITIAL_MEETINGS: Meeting[] = [
  ...
  },
  {
    ...
    link: 'https://meet.google.com/ssl-transpacifico-demo',
    status: 'Realizada',
    qualificationNotes: 'Gabriela Fuentes (Transportes del Pacífico). Demo técnica completada con directores de operaciones. Propuesta enviada por $30k.',
    createdAt: '2026-08-24',
  },
  {
    id: 'meet-7',
    leadId: 'lead-15',
    closerName: 'David Paredes (Director Comercial FBP)',
    dateTime: '2026-08-25 16:00',
    link: 'https://meet.google.com/fbp-neocambio-close',
    status: 'Realizada',
    qualificationNotes: 'Matías Rivas (NeoCambio). Cierre de contrato anual por $45k USD.',
    createdAt: '2026-08-19',
  },
];
...
export const INITIAL_PROPOSALS: Proposal[] = [
  ...
  },
  {
    id: 'prop-3',
    leadId: 'lead-11',
    title: 'Modernización Cloud ERP & Gestión Logística Integrada',
    totalAmount: 30000,
    deliverables: 'Módulos WMS, TMS, conciliación de facturas electrónicas y conector API en tiempo real.',
    paymentTerms: '40% anticipo, 40% hito de migración, 20% entrega final.',
    status: 'Enviada',
    createdAt: '2026-08-28',
  },
  {
    id: 'prop-4',
    leadId: 'lead-13',
    title: 'Growth Scale Retainer Q3 - Campañas D2C & ROAS Optimization',
    totalAmount: 4200,
    deliverables: 'Auditoría integral de anuncios, 15 creatividades mensuales UGC y optimización de tasa de conversión en tienda.',
    paymentTerms: 'Pago mensual de $2,100 USD (contrato por 2 meses renovable).',
    status: 'Enviada',
    createdAt: '2026-08-28',
  },
];
...
export const INITIAL_COMMISSIONS: Commission[] = [
  {
    ...
    concept: 'Venta cerrada NutraHealth Suplementos',
  ...
  },
  {
    id: 'com-2',
    eventType: 'Agendado',
    incomeType: 'Bono fijo',
    companyId: 'comp-1',
    leadId: 'lead-1',
    leadName: 'Carlos Mendoza',
    concept: 'Reunión BANT calificada - Logística Transandina',
  ...
  },
  {
    ...
    companyId: 'comp-2',
    leadId: 'lead-2',
    leadName: 'Valeria Sotomayor',
    concept: 'Reunión agendada - Moda & Retail D2C',
    valueGenerated: 4500,
  ...
  },
  {
    ...
    companyId: 'comp-3',
    leadId: 'lead-15',
    leadName: 'Matías Rivas',
    concept: 'Venta cerrada NeoCambio Fintech & Remesas',
    productName: 'Contrato Anual Enterprise API Gateway',
    valueGenerated: 45000,
    commissionPercent: 10, // 10% = $4,500
    isFixedAmount: false,
    status: 'Aprobada',
    date: '2026-08-26',
    notes: 'Contrato corporativo cerrado con NeoCambio Fintech. Comisión pactada del 10%.',
  },
  {
    id: 'com-5',
    eventType: 'Agendado',
    ...
    companyId: 'comp-1',
    leadId: 'lead-11',
    leadName: 'Gabriela Fuentes',
    concept: 'Reunión demo técnica calificada - Transportes del Pacífico',
    valueGenerated: 30000,
    commissionPercent: 100,
    isFixedAmount: true,
    status: 'Pagada',
    date: '2026-08-28',
    notes: 'Reunión realizada exitosamente con presentación de propuesta técnica.',
  },
  {
    id: 'com-6',
    eventType: 'Cerrado',
    ...
    companyId: 'comp-1',
    leadId: 'lead-8',
    leadName: 'Jorge Benítez',
    concept: 'Cierre histórico - Servicios Industriales',
  ...
  },
  {
    ...
    incomeType: 'Bono fijo',
    companyId: 'comp-3',
    leadName: 'Rodrigo Fernández',
    concept: 'Reunión preliminar VP Comercial Fintech',
    valueGenerated: 30000,
    commissionPercent: 100, // Bono fijo = $100
    isFixedAmount: true,
    status: 'Pendiente',
    date: '2026-08-28',
    notes: 'Prospecto agendado por canal directo. Pendiente de crear ficha completa en CRM.',
  },
];
